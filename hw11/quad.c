 ...
 */
	...
	{
		quad1->next = q2;
		quad2->next = new_quad( '[', st->type, index, quad1->dst_type, quad1->dst_index, quad2->dst_type, quad2->dst_index);
	}
	else
	{
		...
		quad1->next->next = q2;
		quad2->next = new_quad( '[', st->type, index, quad1->next->dst_type, quad1->next->dst_index, quad2->dst_type, quad2->dst_index);
	}
	return q1;
}
