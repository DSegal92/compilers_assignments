...
extern TUPLE *new_tuple( int token, unsigned char value, int 
address, int mask, char *buffer, int length);
...
extern TUPLE *generate_quad_instruction( int instruction, int 
type, int index);
